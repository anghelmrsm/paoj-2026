...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Adaugat: " + service.addTask("Fix login bug", Priority.CRITICAL));
        System.out.println("Adaugat: " + service.addTask("Add dark mode", Priority.LOW));
        System.out.println("Adaugat: " + service.addTask("Update docs", Priority.MEDIUM));
        System.out.println("Adaugat: " + service.addTask("Fix memory leak", Priority.HIGH));
        System.out.println("Adaugat: " + service.addTask("Refactor DB layer", Priority.HIGH));
        ...
        try {
            throw new DuplicateTaskException("Task-ul cu ID T001 există deja.");
        } catch (DuplicateTaskException e) {
            System.out.println("DuplicateTaskException: " + e.getMessage());
        }

        try {
            service.assignTask("T100", "Ion");
